  ...
  return (
    <div className="px-8 py-2">
      ...
      <div className="flex justify-between ">
        ...
        <div className="rounded-md p-3 bg-themecolor-900 w-[48%] text-themecolor-400">
          <div className="">
            <span className="text-sm">ICP certificadora</span>
          </div>
          <div>
            {" "}
            <span className=" text-themecolor-50 text-4xl">
      ...
      <div className="rounded-md p-3 mt-6 bg-themecolor-900 text-themecolor-400">
        <div>
          <h2 className="text-2xl text-themecolor-100">Lista de Pedidos</h2>
        </div>
        <div className="w-full flex justify-between text-xs mb-4 mt-4 ">
